...
image: 
  path: /assets/drafts/images/so-simple-sample-image-5.jpg
  thumbnail: /assets/drafts/images/so-simple-sample-image-5-400x200.jpg
...
![image-center]({{ '/assets/drafts/images/image-alignment-580x300.jpg' | absolute_url }}){: .align-center}

The image should be **centered** with the `.align-center` class.

![image-left]({{ '/assets/drafts/images/image-alignment-150x150.jpg' | absolute_url }}){: .align-left} The rest of this paragraph is filler for the sake of seeing the text wrap around the 150×150 image, which is **left aligned** with the `.align-left` class.
...
![no-alignment]({{ '/assets/drafts/images/image-alignment-1200x4002.jpg' | absolute_url }})

The image above, though `1200px` wide, should not overflow the content area. It should remain contained with no visible disruption to the flow of content.

![image-right]({{ '/assets/drafts/images/image-alignment-300x200.jpg' | absolute_url }}){: .align-right}
...
<figure class="align-center">
  <a href="#"><img src="{{ '/assets/drafts/images/image-alignment-580x300.jpg' | absolute_url }}" alt=""></a>
...
<figure style="width: 150px" class="align-left">
  <img src="{{ '/assets/drafts/images/image-alignment-150x150.jpg' | absolute_url }}" alt="">
...
<figure style="width: 1200px">
  <img src="{{ '/assets/drafts/images/image-alignment-1200x4002.jpg' | absolute_url }}" alt="">
...
<figure style="width: 300px" class="align-right">
  <img src="{{ '/assets/drafts/images/image-alignment-300x200.jpg' | absolute_url }}" alt="">
